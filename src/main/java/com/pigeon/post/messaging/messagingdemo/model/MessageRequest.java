...
import com.pigeon.post.messaging.messagingdemo.configurations.Extended;
import com.pigeon.post.messaging.messagingdemo.utils.isFound;
...
public class MessageRequest {
    ...
    @isFound(message = "to parameter not found", groups = Extended.class)
    private String from;
